...
String topQuestions[] = {"1421x123", "1421x123", "1421x123","10-4", "14+12"};
String bottomQuestions[] = {"174783", "174784", "174782", "6", "27"};
int maxNumQuestions = 5;
int NumQuestions = 0;
int answers[] = {1, 0, 0, 1, 0};    //1 is correct - 0 is wrong
int score = 0;
int lives = 3;
void setup()
{
...
void loop()
{
    ...
    if (lives==0 || NumQuestions == maxNumQuestions)            //5 questions solved? --> score
    {
        showScore();
        reset();
    }
